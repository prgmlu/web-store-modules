...
import VideoMarker from '../../lib/VideoMarker';
...
class ThreeJSWorld extends Component {
    ...
    componentDidMount() {
        ...
        this.nm = new VideoMarker('https://en.wikipedia.org', () => {});
        ...
        this.nm.setTransform(
            [0.7, 0, 0, 0, 0, 0.7, 0, 0, 0, 0, 0.7, 0, 14.43667409774441, 2.7383500742570774, -2.707600511099131, 1],
        );
        this.nm.setColliderTransform(
            [6.88, 0, 0, 0, 0, 8.49, 0, 0, 0, 0, 6.88, 0, 13.959476880937839, -1.9203562512971515, -4.825849916097628, 1],
        );
