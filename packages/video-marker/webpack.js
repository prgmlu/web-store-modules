        ...
        rules: [
            {
                test: /\.(js|jsx)$/,
                use: 'babel-loader',
                exclude: /node_modules\/(?!(three-cursor-style|three-svg|asset-loader|pop-up-component|three-background|three-controller|three-interactable-object|three-physics)\/).*/,
            },
            {
